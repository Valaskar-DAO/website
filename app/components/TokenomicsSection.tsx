  ...
  return (
    <section className="section" id="tokenomics">
      <div className="container">
        ...
        <div className="token-total" data-aos="zoom-in" data-aos-delay="100">
        ...
        <div className="tokenomics-grid">
          <div className="token-card" data-aos="flip-left" data-aos-delay="0">
