    ...
    <section className="section" id="governance">
      <div className="container">
        ...
        <div className="gov-flow">
          ...
          <div className="gov-step" data-aos="fade-up" data-aos-delay="0">
            <div className="gov-step-num">1</div>
            <h4>{dict.step1Title}</h4>
            <p>{dict.step1Desc}</p>
          </div>
          <div className="gov-step" data-aos="fade-up" data-aos-delay="100">
            <div className="gov-step-num">2</div>
            <h4>{dict.step2Title}</h4>
            <p>{dict.step2Desc}</p>
          </div>
          <div className="gov-step" data-aos="fade-up" data-aos-delay="200">
            <div className="gov-step-num">3</div>
            <h4>{dict.step3Title}</h4>
            <p>{dict.step3Desc}</p>
          </div>
          <div className="gov-step" data-aos="fade-up" data-aos-delay="300">
            <div className="gov-step-num">4</div>
            <h4>{dict.step4Title}</h4>
            <p>{dict.step4Desc}</p>
          </div>
          <div className="gov-step" data-aos="fade-up" data-aos-delay="400">
        ...
        <div className="gov-details">
          <div className="gov-detail-card" data-aos="zoom-in" data-aos-delay="0">
            <h4>{dict.standardTitle}</h4>
            <p>{dict.standardDesc}</p>
          </div>
          <div className="gov-detail-card" data-aos="zoom-in" data-aos-delay="100">
            <h4>{dict.criticalTitle}</h4>
            <p>{dict.criticalDesc}</p>
          </div>
          <div className="gov-detail-card" data-aos="zoom-in" data-aos-delay="200">
